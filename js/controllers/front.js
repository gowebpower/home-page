   ...
   // Main Controller
    ...
    (function(){
        ...
        function aboutMeCtrl($scope, f_carousel, f_aboutExperience){
            ...
            // -----------------------  f_carousel
            $scope.carousel = f_carousel.load(4);

            $scope.carousel2 = f_carousel.load(4);

            $scope.carousel3 = f_carousel.load(4);

            $scope.carousel4 = f_carousel.load(4);


            // var makeCarousel = makeCarousel function(howMany){

            //     for( var i = 0; i < howMany; i++){
            //         var name = $scope.carousel + i;

            //         name = f_carousel.load();
